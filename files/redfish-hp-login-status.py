#!/usr/bin/python3
#
# redfish-hp-login-status.py
#



##
## THIS SCRIPT REQUIRES PYTHON > v3
##
...
parser = argparse.ArgumentParser(description="redfish utility for hp: test login credentials and output 'true' or 'false'")
